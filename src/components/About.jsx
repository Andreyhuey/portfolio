        ...
        <div className="flex flex-col items-center justify-center w-full">
          <div className=" my-10 flex flex-col gap-4 items-center justify-center text-center max-w-lg">
            ...
            <div className="flex flex-col gap-6">
              <p>
                A tech enthusiast passionate about building aesthetically
                beautiful & functional software. I also love creating, consuming
                & designing APIs (Application Programming Interfaces) and their
                data.
              </p>
              <p>
                Join me on this journey through the realms of technology, where
                I blend the artistry of front-end development with the precision
                of back-end engineering. From building sleek user interfaces to
                architecting scalable server systems, I thrive on the dynamic
                challenges that come with shaping the digital landscape.
              </p>
            </div>
